...
import { AuthorizeOAuthQueryDto, ApproveOAuthDto } from '@turbotech/social-nestjs-libraries/dtos/oauth/authorize-oauth.dto';
import { TokenExchangeDto } from '@turbotech/social-nestjs-libraries/dtos/oauth/token-exchange.dto';
