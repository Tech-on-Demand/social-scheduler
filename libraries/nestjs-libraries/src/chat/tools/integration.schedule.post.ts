import { AgentToolInterface } from '@turbotech/social-nestjs-libraries/chat/agent.tool.interface';
...
import { AllProvidersSettings } from '@turbotech/social-nestjs-libraries/dtos/posts/providers-settings/all.providers.settings';
import { validate } from 'class-validator';
import { Integration } from '@prisma/client';
import { checkAuth } from '@turbotech/social-nestjs-libraries/chat/auth.context';
import { stripHtmlValidation } from '@turbotech/social-helpers/utils/strip.html.validation';
import { weightedLength } from '@turbotech/social-helpers/utils/count.length';
